...
static int torchDuty[e_DutyNum]=    {35,71,106,127,0,0,0,0,0,0,0};
//50,100,150,179ma
static int flashDuty[e_DutyNum]=     {3,8,12,14,16,20,25,29,33,37,42};
...
//	PK_DBG(" FL_Enable temp=%d\n",temp);
	...
	{
			PK_DBG(" FL_Enable line=%d\n",__LINE__);
			 LM3643_write_reg(LM3643_i2c_client,LM3643_REG_TORCH_LED1, 0x47);//100ma
			 LM3643_write_reg(LM3643_i2c_client,LM3643_REG_ENABLE, temp|0x09);
	}
	else
	{
		PK_DBG(" FL_Enable line=%d\n",__LINE__);
              ...
              LM3643_write_reg(LM3643_i2c_client,LM3643_REG_FLASH_LED1, 0x21);//400ma
              LM3643_write_reg(LM3643_i2c_client,LM3643_REG_ENABLE, temp|0x0D);	
	}
#endif	
