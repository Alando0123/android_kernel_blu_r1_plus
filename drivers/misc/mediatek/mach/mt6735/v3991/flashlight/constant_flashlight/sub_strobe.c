...
static int torchDuty[e_SubDutyNum]=    {42,42};//fix 60
//50,100,150,179ma
static int flashDuty[e_SubDutyNum]=     {8,8};//fix 100
...
//50,100,150,179ma
static int flashDuty[e_SubDutyNum]=     {4,8,12,16};
//200,250,300,350,400,450,500,550,600,650,700,750,800,850,900,950,1000,1100,1200,1300,1400,1500ma
...
static int FL_Enable(void)
{
	...
	if(gDuty == 0)
	{
		...
		LM3643_write_reg_ext(LM3643_REG_TORCH_LED2, 0x2a);

		LM3643_write_reg_ext(LM3643_REG_ENABLE, temp|0x0a);

		//LM3643_write_reg_ext(LM3643_REG_TORCH_LED2, 0x11/*torchDuty[gDuty]*/);
		PK_DBG(" FL_Enable torchDuty[gDuty]=%d\n",torchDuty[gDuty]);
		PK_DBG(" FL_Enable sub line=%d\n",__LINE__);
	}
	else	
	{
		...
		LM3643_write_reg_ext(LM3643_REG_FLASH_LED2, flashDuty[gDuty]/*0x08*/);

              LM3643_write_reg_ext(LM3643_REG_ENABLE, temp|0x0e);	
		
		PK_DBG(" FL_Enable flashDuty[gDuty]=%d\n",flashDuty[gDuty]);
		PK_DBG(" FL_Enable sub line=%d\n",__LINE__);
	}
#endif
	return 0;
